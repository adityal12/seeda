    ...
    def request(self, method, end_point, key_check, data=None):
        try:
            ...
            if "failed to parse" in response.text:
                ...
                time.sleep(random.randint(240, 360))#this code can rendom sleep time 4 to 6 minit
...
print(r"""{}
 ...
 /_/    \_\ |_____/  |_____|    |_|       |_|    /_/    \_\
        ...
        This code developer name is Aditya Patidar {}""".format(Colors.BLUE, Colors.END))
...
def mine_claimer(NotPxClient: NotPx, session_name: str):
    time.sleep(random.randint(5, 15))  # start with delay...
    ...
    while True:
        ...
        time.sleep(random.randint(3600,3800))
